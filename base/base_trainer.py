...
class BaseTrainer:
    ...
    def __init__(self, config, model, loss, metrics, optimizer, lr_scheduler, resume, train_logger):
        ...
        self.model_optimizer = optimizer['model']
        self.model_lr_scheduler = lr_scheduler['model']
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        state = {
            ...
            'model_lr_scheduler': self.model_lr_scheduler.state_dict(),
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if checkpoint['config']['lr_scheduler']['type'] != self.config['lr_scheduler']['type']:
            ...
            self.model_lr_scheduler.load_state_dict(checkpoint['model_lr_scheduler'])
